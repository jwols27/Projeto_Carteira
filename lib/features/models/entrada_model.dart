...
class EntradaModel extends Movimento {
  EntradaModel(
      ...
      double? valor,
      bool? mov_type = true})
      : super(codigo, pessoa, data_entrada, descricao, valor, mov_type);
  ...
  @override
  String toString() {
    return 'EntradaModel{codigo: $codigo, pessoa: $pessoa, data_entrada: $data, descricao: $descricao, valor: $valor, mov_type: $mov_type}';
  }
